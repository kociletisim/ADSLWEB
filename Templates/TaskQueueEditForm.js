...
var dataModel = {
    ...
    faultList: ko.observableArray([{ name: "Müşteri Hizmetleri" }, { name: "Ürünler Arası Geçiş" }, { name: "Gatio" }, { name: "Giza" }, { name: "Samline" }, { name: "Jade" }, { name: "Tim" }, { name: "Telekomone" }, { name: "Krea Doğrudan Pazarlama" }, { name: "Mert Yükler" }, { name: "KÇM" }, { name: "Techline İletişim" }, { name: "Bornet" }, { name: "Bayi" }, { name: "Sinerji Çağrı" }, { name: "Çağrı Merkezi" }, { name: "Dış Çağrı Merkezi" }, { name: "Diğer" }, { name: "SZD DANIŞMANLIK ARACILIK" }, { name: "ANADOLU TELEKOMÜNİKASYON" }, { name: "SAKA TEKNOLOJİ" }, { name: "MEGANET TEKNOLOJİ" }, { name: "NOVATECH BİLİŞİM" }, { name: "İZNET İLETİŞİM" }, { name: "Homenet" }, { name: "EUROANT İLETİŞİM" }, { name: "GÖKTÜRK İLETİŞİM" }, { name: "NETONLİNE BİLİŞİM" }, { name: "TEOS ILETISIM" }, { name: "BAĞDAT CADDE TURKCELL" }, { name: "PERA TURKCELL" }, { name: "NEXT LEVEL AVM TURKCELL" }, { name: "MARKANTALYA AVM TURKCELL" }, { name: "KANYON TURKCELL" }, { name: "CAPITOL TURKCELL" }]),
